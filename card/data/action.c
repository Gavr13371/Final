Action()
{
	...
	lr_end_transaction("busket",LR_AUTO);
	...
	web_custom_request("shippingcost", 
		...
		"Body={\"seaddress\":{\"addressLine1\":\"Lenina\",\"addressLine2\":\"\",\"city\":\"Moscow\",\"country\":\"fr\",\"postalCode\":\"\",\"state\":1},\"secustomerName\":\"Kirill Kiriillov\",\"secustomerPhone\":\"89297578383\",\"senumberOfProducts\":2,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"08B22B121D4D4D8171B0A2BDF6E3025C\"}", 
		LAST);
	...
	lr_end_transaction("checout",LR_AUTO);
